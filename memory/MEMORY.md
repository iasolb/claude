...
- [PC layout](pc-layout.md): stub for the Windows machine, fill in from a session there
- [Memory-bank ownership](memory-bank-ownership.md): claude-memory-bank is Claude's repo to commit in, all others are Ian's
